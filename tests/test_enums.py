...
class TestMaterialModelType(SolidMaterialTestCase):
    ...
    def test_shell_uflyand_mindlin_stress_variables(self):
        self.assertEqual(MaterialModelType.SHELL_UFLYAND_MINDLIN.number_of_stress_variables, 5)

    def test_shell_kirchhoff_love_stress_variables(self):
        self.assertEqual(MaterialModelType.SHELL_KIRCHHOFF_LOVE.number_of_stress_variables, 5)
